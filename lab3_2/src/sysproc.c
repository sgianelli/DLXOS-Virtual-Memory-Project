...
//  ProcessFork (&emptyLoop, 1, "Loop1", 0);
//  ProcessFork (&emptyLoop, 2, "Loop1", 0);
//  ProcessFork (&emptyLoop, 3, "Loop1", 0);
//  ProcessFork (&doSomething, 1, "Creator1", 0);
//  ProcessFork (&doSomething, 2, "Creator2", 0);
